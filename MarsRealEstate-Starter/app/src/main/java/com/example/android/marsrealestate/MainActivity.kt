...
class MainActivity : AppCompatActivity() {
     ...
     * with [WindowInsetsCompat.Type.systemBars] as the argument. It then gets the insets
     * for the IME (keyboard) using [WindowInsetsCompat.Type.ime]. It then updates the layout
