 ...
 * for that attribute on the [TextView] with ID R.id.sleep_length in the layout file used for
 ...
 * to the formatted string that our [convertDurationToFormatted] method produces from the
