...
class MainActivity : AppCompatActivity() {
     ...
     * [ViewCompat.setOnApplyWindowInsetsListener] method to set an [OnApplyWindowInsetsListener]
     * to take over over the policy for applying window insets to `rootView`, with the`listener`
